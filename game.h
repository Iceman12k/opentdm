...
typedef struct {
    ...
    trace_t     (*clip)(const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end, edict_t *clip, int contentmask);
...
game_export_ex_t * IMPORT GetGameApiEx(game_import_ex_t *importx);